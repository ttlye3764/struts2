                ...
                <div class="caption" id ="clickDiv">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6">
                            ...
                            <a class="btn btn-success" id = "clickBtn" href="/user/imageboardView.do?img_no=${imageBoardInfo.img_no }&img_rnum=${imageBoardInfo.rnum }">글 보기</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div>
<form action="/user/imageboardList.do" method="post" class="form-inline pull-right">
